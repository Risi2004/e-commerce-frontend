...
function MonitorPage() {
  ...
  const uniqueBrands = [...new Set(monitors.map((item) => item.brand))];

  const handleAddToCart = (item) => {
    addToCart({ ...item, type: "Monitor" });
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-purple-50">
      ...
      {/* Hero Section */}
      <div className="relative overflow-hidden bg-gradient-to-r from-blue-700 via-indigo-800 to-purple-900 text-white py-16 px-6">
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center justify-center w-20 h-20 bg-white/10 backdrop-blur-lg rounded-2xl mb-6">
            <svg
              ...
              aria-hidden="true"
            >
              <path d="M4 5h16v12H4zM3 17h18v2H3zM8 19h8v1H8z" />
            </svg>
          </div>
          ...
          <p className="text-xl text-blue-200 max-w-2xl mx-auto">
            Explore crisp, vibrant monitors for gaming, work, and entertainment.
          </p>
          <div className="mt-6 flex items-center justify-center gap-4 text-blue-200">
            <div className="flex items-center gap-2">
              <span className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></span>
              <span className="text-sm">{filteredMonitors.length} Products Available</span>
            </div>
          </div>
        </div>
      </div>
          ...
          >
            <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-gray-50 to-gray-100 p-4 mb-6 w-full">
              <img
                ...
                src="/images/monitor/27'' Dell S2721DGF (165Hz, QHD).jpg"
                alt={item.name}
            ...
            <p className="text-gray-600 mb-2 text-center">
              <strong>{item.specs?.Size || "N/A"}</strong> • <strong>{item.specs?.Resolution || "N/A"}</strong>
            </p>

            <p className="text-gray-600 mb-6 text-center">
              Refresh Rate: {item.specs?.RefreshRate || "N/A"}
            </p>
            ...
            <div className="flex items-center justify-between w-full mt-auto">
              ...
              <button
                ...
                className="bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white py-3 px-6 rounded-xl font-semibold transition-all duration-200 transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                Add to Cart
              </button>
            </div>
      ...
      {filteredMonitors.length === 0 && (
        <p className="text-center text-gray-500 mt-10">No monitors found.</p>
      )}
    </div>
  );
}
